...
const ServiceCard = (props: any) => {
  return (
    <SplideSlide className="w-1/4">
      <div
        className="  flex flex-col items-center md:p-0 md:mx-3 text-accent md:py-5 shadow-md"
        data-aos="fade-up"
      >
        <svg
          version="1.1"
        ...
        <div className="title text-2xl p-5">Hair styling services</div>
        <div className="desc leading-relaxed font-sans  p-5 w-5/6">
