...
const Service = () => {
    return (
        ...
        <div className="services-m md:flex md:p-10 md:justify-center">
        
          <div
            className="bg-white m-6 flex flex-col items-center md:w-1/6 md:py-5   text-accent"
            data-aos="fade-up"
          >
            <svg
              version="1.1"
              className="fill-inherit w-10 py-7"
              id="Layer_1"
            ...
            <div className="title text-2xl pb-5">Hair styling services</div>
            <div className="desc leading-relaxed font-sans text-xs">
              Our unisex hair styling services give you the perfect look for any
              occasion.
            </div>
          </div>
          <div
          ...
          <div
            className="bg-white m-6  flex flex-col items-center md:p-0 md:w-1/6 text-accent md:py-5 "
            data-aos="fade-up"
          >
            <svg
              version="1.1"
